...
groups_path = r'C:\Users\Mohamed Khalil\Desktop\Custodian\custodian\custodian\Resources\groups'
RBAC_df = pd.read_excel(r'C:\Users\Mohamed Khalil\Desktop\Custodian\custodian\custodian\Resources\RBAC Sample.xlsx')
HR_df = pd.read_excel(r'C:\Users\Mohamed Khalil\Desktop\Custodian\custodian\custodian\Resources\HR Sheet - Dummy Data.xlsx')
...
def RBAC_apps(title):
    rbac = pd.read_excel(r'C:\Users\Mohamed Khalil\Desktop\Custodian\custodian\custodian\Resources\RBAC Sample.xlsx')
...
def daily_data(id):
    ...
    df = pd.read_excel(r'C:\Users\Mohamed Khalil\Desktop\Custodian\custodian\custodian\Resources\Daily Sheet Sample.xlsx')
